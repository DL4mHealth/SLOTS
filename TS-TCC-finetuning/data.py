...
#     # y_train_2 = y_train_1.reshape(-1, )
#
#     train_data_labeled = torch.from_numpy(train_data_2).type(torch.FloatTensor)
#     # y_train_labeled = torch.from_numpy(y_train_2).type(torch.LongTensor)
#
#
#     test_data_1 = source_subject_data[index_test]
#     test_data_2 = test_data_1.reshape(-1, 32, 128)
...
#     # #
#     # train_labeled_dataset = TensorDataset(train_data_labeled, y_train_labeled)
#     # train_labeled_loader = DataLoader(dataset=train_labeled_dataset, batch_size=100, shuffle=True)
#     train_unlabeled_dataset = TensorDataset(train_data_labeled)
#     train_unlabeled_loader = DataLoader(dataset=train_unlabeled_dataset, batch_size=100, shuffle=True)
#
#
#
#     test_dataset = TensorDataset(test_data, y_test)
...
#
#     # return train_data, y_train, test_data, y_test
#     return train_unlabeled_loader, test_loader
...
def get_loader2(dataset, split_idx, num_labeled,batch_labeled,batch_unlabeled):
    ...
    if dataset == 'P19':
        base_path = '/data0/caihlFiles/P19data'
    # elif dataset == 'P19':
    #     base_path = '../P19data'
    # elif dataset == 'eICU':
    #     base_path = '../eICUdata'
...
def get_loader_DEAP_SEED(cur_dim, curr_fold, data_file,num_labeled,batch_labeled,batch_unlabeled):
    ...
    dataset_dir1 = "/data0/caihlFiles/deap_shuffled_data/" + cur_dim + "/"  # + "rnn" + "/"

    # cnn_suffix = ".mat_win_128_rnn_dataset.pkl"
    # label_suffix = ".mat_win_128_labels.pkl"
    dataset_dir2 = "/data0/caihlFiles/seed_shuffled_data" + "/"  # + "rnn" + "/"
