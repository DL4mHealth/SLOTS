...
# dict_performance = {}
    for curr_fold in range(fold):
        ...
        loss_log = model.fit(train_unlabeled_loader,verbose=True,n_epochs=3)

        model_copy = copy.deepcopy(model)

        loss, performance = model_copy.finetune_fit(train_labeled_loader, test_loader, finetune_epochs=3,finetune_lr=0.0001)
