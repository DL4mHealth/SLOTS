...
if __name__ == '__main__':
    ...
    for looptime in range(loop):
        ...
        for curr_fold in range(fold):
            ...
            #     = get_loader3(sourcedata_path, curr_fold, num_labeled, batch_labeled, batch_unlabeled) #  Epilepsy HAR
            ...
            model = TS2Vec(
                input_dims=32, # channels=32 DEAP
                # input_dims=62,  # SEED
                # input_dims=60, # P19
                # input_dims=1, # Epilepsy
                # input_dims=1, # HAR
                device=0,
                batch_size=128,
                depth=12,
