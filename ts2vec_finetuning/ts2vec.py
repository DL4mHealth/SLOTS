...
class TS2Vec:
    ...
    def fit(self, train_unlabeled_loader, n_epochs=None, n_iters=None, verbose=False):
        ...
        while True:
            ...
            # for batch in train_loader:
                ...
                optimizer.zero_grad()
                aa=crop_offset + crop_eleft
                bb=crop_right - crop_eleft
                cc=crop_offset + crop_left
                dd=crop_eright - crop_left
    ...
    def finetune_fit(self, train_labeled_loader, test_loader, mask=None, encoding_window=None,
        ...
        # self.proj_head = ProjectionHead(input_dims=self.output_dims, output_dims=2, hidden_dims=128).to(self.device) #DEAP P19 Epilepsy
        # self.proj_head = ProjectionHead(input_dims=self.output_dims, output_dims=3, hidden_dims=128).to(self.device)  # SEED
        self.proj_head = ProjectionHead(input_dims=self.output_dims, output_dims=6, hidden_dims=128).to(self.device)  # HAR
